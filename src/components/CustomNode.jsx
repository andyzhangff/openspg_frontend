...
const CustomNode = memo(({ data }) => {
  return (
    <div className="flex items-center justify-center w-20 h-20 bg-blue-500 rounded-full border-4 border-blue-600 shadow-lg hover:shadow-xl transition-shadow">
